...
module lab61_soc_mm_interconnect_0 (
	...
	wire   [27:0] accum_s1_agent_m0_address;                                                          // accum_s1_agent:m0_address -> accum_s1_translator:uav_address
	...
	wire  [104:0] accum_s1_agent_rf_source_data;                                                      // accum_s1_agent:rf_source_data -> accum_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] accum_s1_agent_rsp_fifo_out_data;                                                   // accum_s1_agent_rsp_fifo:out_data -> accum_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> accum_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // accum_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> accum_s1_agent:cp_channel
	...
	wire  [103:0] accum_s1_agent_rp_data;                                                             // accum_s1_agent:rp_data -> router_009:sink_data
